...
class m181018_070730_create_table_survey_question extends Migration
{
    public function up()
    {
        ...
        $this->createTable('{{%s_survey_question}}', [
        ...
        $this->createIndex('fk_survey_question_to_survey_idx', '{{%s_survey_question}}', 'survey_question_survey_id');
        $this->createIndex('fk_survey_question_to_type_idx', '{{%s_survey_question}}', 'survey_question_type');
    }

    public function down()
    {
        $this->dropTable('{{%s_survey_question}}');
    }
}
