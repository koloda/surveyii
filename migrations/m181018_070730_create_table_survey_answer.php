...
class m181018_070730_create_table_survey_answer extends Migration
{
    public function up()
    {
        ...
        $this->createTable('{{%s_survey_answer}}', [
        ...
        $this->createIndex('fk_survey_answer_to_question_idx', '{{%s_survey_answer}}', 'survey_answer_question_id');
    }

    public function down()
    {
        $this->dropTable('{{%s_survey_answer}}');
    }
}
