...
class m181018_070730_create_table_survey extends Migration
{
    public function up()
    {
        ...
        $this->createTable('{{%s_survey}}', [
            ...
            'survey_updated_at' => $this->timestamp()->defaultExpression('CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP'),
            'survey_expired_at' => $this->timestamp()->defaultValue(null),
        ...
        $this->createIndex('fk_survey_created_by_idx', '{{%s_survey}}', 'survey_created_by');
    }

    public function down()
    {
        $this->dropTable('{{%s_survey}}');
    }
}
